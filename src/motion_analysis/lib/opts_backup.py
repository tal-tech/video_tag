...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--fps', type=int, default=3, help='')
    self.parser.add_argument('--resize', action='store_false', help='resize video or not, default false')
    self.parser.add_argument('--resolution', type=int, default=540, help='set --resize true if you want change resize resolution')
    self.parser.add_argument('--output', type=str, help='output file name')
